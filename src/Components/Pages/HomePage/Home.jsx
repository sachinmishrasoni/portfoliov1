...
const Home = () => {
    ...
    const socialMedia = [
        { icon: LinkedIn, link: 'https://www.linkedin.com/in/sachinmishrasoni/' },
        { icon: GitHub, link: 'https://github.com/sachinkumarf103' },
        { icon: Facebook, link: 'https://www.facebook.com/sachinmishrasoni' },
        { icon: Instagram, link: 'https://www.instagram.com/sachinmishrasoni/' }
    ];

    const downloadCV = () => {
        let link = document.createElement('a');
        link.href = '/Sam_Cv.pdf';
        link.download = 'SAM CV';
        link.target = '_blank'
        link.click();
    };
    return (
            ...
            >
                ...
                <Box height={'100%'} display={'flex'} flexDirection={{ xxs: 'column-reverse', sm: 'row' }} justifyContent={'center'} alignItems={'center'}>
                    ...
                    <Box mt={{ xxs: 5, md: 0 }}>
                        ...
                        <TextEffectFramer secVal={1}><Typography sx={{ typography: { xxs: 'h5', xs: 'h4' }, '&.MuiTypography-root': { fontWeight: 'bold' } }}>Sachin Mishra</Typography></TextEffectFramer>
