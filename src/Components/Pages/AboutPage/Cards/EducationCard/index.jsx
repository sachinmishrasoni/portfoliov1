    ...
    <Paper ref={paperRef} sx={{
      ...
      <Stack direction={'row'} alignItems={'center'} justifyContent={'space-between'}>
        ...
        <Paper
          ...
          <Typography fontWeight={'bold'} variant='caption' lineHeight={0} color={'black'}>{data.year}</Typography>
        </Paper>
      </Stack>
      <Stack direction={'row'} alignItems={'center'} justifyContent={'space-between'}>
        <Typography variant='body2' color={'mypresetcolor.highlightColor'}>{data.course}</Typography>
        <Typography variant='caption' textAlign={'right'}>{data.address}</Typography>
      </Stack>
